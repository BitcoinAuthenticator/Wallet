...
public class PaperSSSQR extends BASE{
	...
	public BufferedImage generatePaperWallet(Share share, long creationTime) throws IOException{
		Image qrSSS = createQRSSSImage(share, creationTime);
		return completePaperWallet(share.toString(), qrSSS);
	}
	...
	private BufferedImage completePaperWallet(String pieceHex, Image qrSSS) throws IOException{
        URL location = Main.class.getResource("/wallettemplate/startup/PaperWalletSSS.png");
